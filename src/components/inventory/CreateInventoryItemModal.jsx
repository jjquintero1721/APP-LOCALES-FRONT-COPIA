...
const CreateInventoryItemModal = ({ isOpen, onClose }) => {
  const { createInventoryItemMutation } = useInventory();
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const formattedData = {
        ...data,
        quantity_in_stock: parseFloat(data.quantity_in_stock) || 0,
    ...
    <div className="modal-overlay" onClick={handleClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h2>Crear Ítem de Inventario</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="modal-body">
            ...
            <div className="form-row">
              <div className="form-group">
                <label htmlFor="quantity_in_stock">Stock Inicial</label>
                <input
                  type="number"
